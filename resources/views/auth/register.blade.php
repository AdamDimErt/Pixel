                ...
                <div class="row">
                    ...
                    <div class="file-field input-field col s12">
                        ...
                        <div class="file-path-wrapper">
                            ...
                            <input id="file-path" class="file-path" type="text" placeholder="Удостоверение личности (с двух сторон)">
                        </div>
                    </div>
                    <div class="input-field col s12">
                    ...
                    <div class="input-field col s12">
                        ...
                        <input name="password_confirmation" type="password" placeholder="Подтвердите пароль" class="white-text">
                    </div>
                    <div class="input-field col s12">
